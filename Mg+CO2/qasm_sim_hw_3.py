...
def callback(eval_count, param, val,meta):  
    ...
    write_dict(interim_info,f'../VQE_results/MG+CO2_ibmq_qasm_simulator_4qubit_interim_info_{int(distances[0]*10)}')
...
write_list(vqe_results,f'../VQE_results/MG+CO2_ibmq_qasm_simulator_4qubit_vqe_results_{int(distances[0]*10)}')
write_list(vqe_problems,f'../VQE_problems/MG+CO2_ibmq_qasm_simulator_4qubit_vqe_problems_{int(distances[0]*10)}')