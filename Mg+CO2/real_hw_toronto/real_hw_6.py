...
def callback(eval_count, param, val,meta):  
    ...
    write_dict(interim_info,f'../VQE_results/MG+H2O_ibmq_toronto_7qubit_interim_info_{int(distances[1]*10)}')
...
write_list(vqe_results,f'../VQE_results/MG+H2O_ibmq_toronto_7qubit_vqe_results_{int(distances[1]*10)}')
write_list(vqe_problems,f'../VQE_problems/MG+H2O_ibmq_toronto_7qubit_vqe_problems_{int(distances[1]*10)}')