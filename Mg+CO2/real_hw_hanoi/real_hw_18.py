...
def callback(eval_count, param, val,meta):  
    ...
    write_dict(interim_info,f'../VQE_results/MG+H2O_ibm_hanoi_4qubit_zne_interim_info_{int(distances[5]*10)}')
...
vqe_results,vqe_problems,dists=real_solver(distances=[distances[5]],
                                            mapper=mapper,
                                            optimizer=optimizer,
                                            freeze_core=False,
...
write_list(vqe_results,f'../VQE_results/MG+H2O_ibm_hanoi_4qubit_zne_vqe_results_{int(distances[5]*10)}')
write_list(vqe_problems,f'../VQE_problems/MG+H2O_ibm_hanoi_4qubit_zne_vqe_problems_{int(distances[5]*10)}')