...
write_list(vqe_results,f'../VQE_results/MG+CO2_ibm_cairo_4qubit_vqe_results_{distances[7]}')
write_list(vqe_problems,f'../VQE_problems/MG+CO2_ibm_cairo_4qubit_vqe_problems_{distances[7]}')