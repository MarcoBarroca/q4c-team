...
write_list(vqe_results,f'../VQE_results/MG+H2O_nair_4qubit_vqe_results_{distances[9]}')
write_list(vqe_problems,f'../VQE_problems/MG+H2O_nair_4qubit_vqe_problems_{distances[9]}')