...
write_list(vqe_results,f'../VQE_results/MG+H2O_guadal_vqe_results_{int(distances[0]*10)}')
write_list(vqe_problems,f'../VQE_problems/MG+H2O_guadal_vqe_problems_{int(distances[0]*10)}')