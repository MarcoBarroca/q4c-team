...
write_list(vqe_results,f'../VQE_results/MG+H2O_ibm_hanoi_4qubit_vqe_results_{distances[3]}')
write_list(vqe_problems,f'../VQE_problems/MG+H2O_ibm_hanoi_4qubit_vqe_problems_{distances[3]}')