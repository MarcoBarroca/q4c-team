...
def callback(eval_count, param, val,meta):  
    ...
    write_dict(interim_info,f'../VQE_results/MG+H2O_mont_4qubit_zne_interim_info_{int(distances[7]*10)}')
...
write_list(vqe_results,f'../VQE_results/MG+H2O_mont_4qubit_zne_vqe_results_{int(distances[7]*10)}')
write_list(vqe_problems,f'../VQE_problems/MG+H2O_mont_4qubit_zne_vqe_problems_{int(distances[7]*10)}')